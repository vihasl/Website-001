...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        $success = 'Registration successful! <a href="login.php">Sign in here</a>.';
    } else {
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .perks { display: flex; flex-direction: column; gap: 0.5rem; margin-bottom: 1.75rem; }
  .perk { display: flex; align-items: center; gap: 0.6rem; font-size: 0.8rem; color: var(--text-secondary); }
  .perk-dot { width: 6px; height: 6px; border-radius: 50%; background: var(--accent-green); flex-shrink: 0; }
...
<nav id="navbar">
  ...
  <ul class="nav-links" id="navLinks">
    ...
    <li><a href="login.php" class="nav-cta">Sign In</a></li>
  </ul>
...
<main>
  <div class="auth-card">
    <div class="auth-badge"><div class="pulse-dot"></div> Free Account</div>
    <h1 class="auth-title">Create <span class="gradient-text">Account</span></h1>
    <p class="auth-sub">Join ImSata and get access to custom Discord bots &amp; web development services.</p>

    <div class="perks">
      <div class="perk"><div class="perk-dot"></div>Access to all project quotes &amp; updates</div>
      <div class="perk"><div class="perk-dot"></div>Track your bot &amp; web project status</div>
      <div class="perk"><div class="perk-dot"></div>Priority support channel</div>
    </div>
